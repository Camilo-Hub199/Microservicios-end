...
describe('Auth Middleware', () => {
    ...
    test('debe rechazar la petición cuando Authorization solo trae el prefijo Bearer', () => {
        const req = {
            headers: {
    ...
    test('debe rechazar la petición cuando Authorization está vacío tras el Bearer', () => {
        const req = {
            headers: {
                authorization: 'Bearer'
            }
    ...
    test('debe rechazar la petición cuando el token expiró', () => {
        ...
        const token = jwt.sign(payload, APP_SECRET, { expiresIn: '-10s' });
